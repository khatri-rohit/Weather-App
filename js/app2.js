...
(async () => {
  try {
    ...
    nextTiming.forEach((nxtTime) => {
      ...
      arr += 2;
      if (noon === "pm" && time < 12) {
        img[awai].src = ("https://github.com/khatri-rohit/Weather-App/tree/main/img/sunlight.png");
        if (time > 6) {
          img[awai].src = "https://github.com/khatri-rohit/Weather-App/tree/main/img/night.png";
        }
      } else {
        if (time > 6) {
          img[awai].src = ("https://github.com/khatri-rohit/Weather-App/tree/main/img/sunlight.png");
